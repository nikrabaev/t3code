...
import Migration0026 from "./Migrations/026_ProjectionThreadsKind.ts";
import Migration0027 from "./Migrations/027_ProjectionProjectsVerifierCommand.ts";
...
export const migrationEntries = [
  ...
  [26, "ProjectionThreadsKind", Migration0026],
  [27, "ProjectionProjectsVerifierCommand", Migration0027],
] as const;
